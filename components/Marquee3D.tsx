...
const KineticScene = () => {
    return (
        <group>
            <CylinderText text="ANGIE'S BARBER" position={[0, 1.5, 0]} rotationSpeed={0.4} color="#FF6600" />
            <CylinderText text="EST. 2016 • WARSAW" position={[0, 0, 0]} rotationSpeed={-0.4} color="#F5F5F5" />
            <CylinderText text="PRECISION CUTS" position={[0, -1.5, 0]} rotationSpeed={0.4} color="#FF6600" />
        </group>
    )
}
